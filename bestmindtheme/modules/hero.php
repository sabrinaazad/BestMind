<section class="section section--hero full-width no-padded-sides no-padded-top no-padded-bottom">
    ...
    <div class="content-bottom">
        ...
        while( have_rows('bottom_content') ): the_row(); ?>
            ...
            <div class="two-col">
                <div class="col">
                    <?php if( have_rows('bottom_slide') ):?>
                        <div class="bottom_slider">
                        <?php while( have_rows('bottom_slide') ) : the_row(); 
                        $slide = get_sub_field('slide'); ?> 
                           <div class="slide"><img src="<?php echo $slide; ?>" alt="slide image" /></div> 
                        <?php  endwhile; ?>
                        </div>
                        <div class="bottom_slider_2 desktop-only">
                        <?php while( have_rows('bottom_slide') ) : the_row(); 
                        $slide = get_sub_field('slide'); ?> 
                           <div class="slide"><img src="<?php echo $slide; ?>" alt="slide image" /></div> 
                        <?php  endwhile; ?>
